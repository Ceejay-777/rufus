...
const SectionOne = () => {
  return (
    <section className="bg-black text-white p-4 text-center roundbottom pb-10 mb-32">
      ...
      <p className="mb-6">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate eos a
        autem repudiandae deserunt consectetur non quasi quisquam eius at.
      </p>
